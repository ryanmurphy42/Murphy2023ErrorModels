...
# Fig5_ODENonlinear_PoissonNoise_PoissonFit
...
isdir(pwd() * "\\Fig5_ODENonlinear_PoissonNoise_PoissonFit\\") || mkdir(pwd() * "\\Fig5_ODENonlinear_PoissonNoise_PoissonFit") # make folder to save figures if doesnt already exist
filepath_save = [pwd() * "\\Fig5_ODENonlinear_PoissonNoise_PoissonFit\\"] # location to save figures "\\Fig2\\"] # location to save figures
