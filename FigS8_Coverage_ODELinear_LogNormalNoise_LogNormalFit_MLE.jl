...
# FigS8_Coverage_ODELinear_LogNormalNoise_LogNormalFit_MLE
...
isdir(pwd() * "\\FigS8_Coverage_ODELinear_LogNormalNoise_LogNormalFit_MLE\\") || mkdir(pwd() * "\\FigS8_Coverage_ODELinear_LogNormalNoise_LogNormalFit_MLE") # make folder to save figures if doesnt already exist
filepath_save = [pwd() * "\\FigS8_Coverage_ODELinear_LogNormalNoise_LogNormalFit_MLE\\"] # location to save figures "\\Fig2\\"] # location to save figures
...
## Generate Synthetic data
    ...
    if seednum == 1
        p0modeltrue=plot(t_smooth,data0_smooth[1,:],lw=3,linecolor=colour1,ylims=(0,250)) # solid - c1
    ...
    data_dists=[LogNormal(log(mi),Sd) for mi in model(t,[r1,r2,C10,C20])]; # normal distribution - standard deviation 1
    ...
    if seednum == 1
        ...
        p0scattertest=plot(t_smooth,data0_smooth[1,:],lw=3,linecolor=colour1,ylims=(0,250)) # solid - c1
    ...
    ### Parameter identifiability analysis - MLE, profiles
        ...
        function error(data,a)
            ...
            y=model(t,a);
            e=0;
            data_dists=[LogNormal(log(mi),Sd) for mi in model(t,a[1:2])]; # Normal noise model
        ...
        loop_data_dists_MLE=[LogNormal(log(mi),Sd) for mi in model(t_smooth,[r1mle,r2mle])]; # normal distribution about mean
        ...
        loop_data_dists_MLEd=[LogNormal(log(mi),Sd) for mi in model(t,[r1mle,r2mle])]; # normal distribution about mean
        ...
        if seednum == 1
            ...
            p1mleprediction=scatter!(t,testdata[1,:],ylims=(ymin,ymax),legend=false,markersize = 8,markercolor=:orange,msw=0) # Data - scatter c1
            p1mleprediction=scatter!(t,testdata[2,:],ylims=(ymin,ymax),legend=false,markersize = 8,markercolor=:blue,msw=0) # Data - scatter c2
            ...
            p1mleprediction2=plot!(t_smooth,data0_smooth_MLE[2,:],w=0,c=colour2,ribbon=(data0_smooth_MLE[2,:].-min_realisations_MLE_overall[2,:],max_realisations_MLE_overall[2,:].-data0_smooth_MLE[2,:]),fillalpha=.2,xlab=L"t",ylab=L"c_{1}(t), c_{2}(t)",titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt) # Confidence set for data realisations - c2
            p1mleprediction2=scatter!(t,testdata[1,:],ylims=(ymin,ymax),legend=false,markersize = 8,markercolor=:orange,msw=0) # Data - scatter c1
            p1mleprediction2=scatter!(t,testdata[2,:],ylims=(ymin,ymax),legend=false,markersize = 8,markercolor=:blue,msw=0) # Data - scatter c2
    ...
    #         # Profiling (using the MLE as the first guess at each point)
            ...
            for i in 1:nptss
                ...
                loop_data_dists=[LogNormal(log(mi),Sd) for mi in model(t_smooth,[r1range_upper[i],nr1range_upper[1,i]])]; # normal distribution about mean
                ...
                loop_data_distst=[LogNormal(log(mi),Sd) for mi in model(t,[r1range_upper[i],nr1range_upper[1,i]])]; # normal distribution about mean
            ...
            for i in 1:nptss
                ...
                loop_data_dists=[LogNormal(log(mi),Sd) for mi in model(t_smooth,[r1range_lower[i],nr1range_lower[1,i]])]; # normal distribution about mean
                ...
                loop_data_distst=[LogNormal(log(mi),Sd) for mi in model(t,[r1range_lower[i],nr1range_lower[1,i]])]; # normal distribution about mean
            ...
            for i in 1:nptss
                ...
                loop_data_dists=[LogNormal(log(mi),Sd) for mi in model(t_smooth,[nr2range_upper[1,i],r2range_upper[i]])]; # normal distribution about mean
                ...
                loop_data_distst=[LogNormal(log(mi),Sd) for mi in model(t,[nr2range_upper[1,i],r2range_upper[i]])]; # normal distribution about mean
            ...
            for i in 1:nptss
                ...
                loop_data_dists=[LogNormal(log(mi),Sd) for mi in model(t_smooth,[nr2range_lower[1,i],r2range_lower[i]])]; # normal distribution about mean
                ...
                loop_data_distst=[LogNormal(log(mi),Sd) for mi in model(t,[nr2range_lower[1,i],r2range_lower[i]])]; # normal distribution about mean
...
# Model solution  - r1
coverage_m_r1_c1 = plot(t_smooth[2:end], sum(r1modelsoln_withinbounds_time[:,1,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),lw=3, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour1,legend=false,xlab=L"t",ylab=L"C_{y,0.95}^{r_{1}}")
...
coverage_m_r1_c2 = plot(t_smooth[2:end], sum(r1modelsoln_withinbounds_time[:,2,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),lw=3, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour2,legend=false,xlab=L"t",ylab=L"C_{y,0.95}^{r_{1}}")
...
# Model solution  - r2
coverage_m_r2_c1 = plot(t_smooth[2:end], sum(r2modelsoln_withinbounds_time[:,1,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),lw=3, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour1,legend=false,xlab=L"t",ylab=L"C_{y,0.95}^{r_{2}}")
...
coverage_m_r2_c2 = plot(t_smooth[2:end], sum(r2modelsoln_withinbounds_time[:,2,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),lw=3, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour2,legend=false,xlab=L"t",ylab=L"C_{y,0.95}^{r_{2}}")
...
# Model solution  - union
coverage_m_union_c1  = plot(t_smooth[2:end], sum(modelsoln_withinbounds_time[:,1,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),lw=3, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour1,legend=false,xlab=L"t",ylab=L"C_{y,0.95}")
...
coverage_m_union_c2 = plot(t_smooth[2:end], sum(modelsoln_withinbounds_time[:,2,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),lw=3, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour2,legend=false,xlab=L"t",ylab=L"C_{y,0.95}")
...
coverage_r_r1_c1 = scatter!(t[2:end], sum(r1realisationst_withinbounds_time[:,1,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),markersize=10,msw=0, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,color=colour1,legend=false,xlab=L"t",ylab=L"C_{z_{i},0.95}^{r_{1}}")
...
coverage_r_r1_c2 = scatter!(t[2:end], sum(r1realisationst_withinbounds_time[:,2,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),markersize=10,msw=0, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,color=colour2,legend=false,xlab=L"t",ylab=L"C_{z_{i},0.95}^{r_{1}}")
...
coverage_r_r2_c1 = scatter!(t[2:end], sum(r2realisationst_withinbounds_time[:,1,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),markersize=10,msw=0, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,color=colour1,legend=false,xlab=L"t",ylab=L"C_{z_{i},0.95}^{r_{2}}")
...
coverage_r_r2_c2 = scatter!(t[2:end], sum(r2realisationst_withinbounds_time[:,2,2:end],dims=1)' ./totalseeds,xlim=(-0.1,5.1), ylim=(0,1.1),markersize=10,msw=0, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,color=colour2,legend=false,xlab=L"t",ylab=L"C_{z_{i},0.95}^{r_{2}}")
...
coverage_r_union_c1 = scatter!(t[2:end], sum(realisationst_withinbounds_time[:,1,2:end],dims=1)' ./totalseeds,xlim=(-0.1,5.1), ylim=(0,1.1),markersize=10,msw=0, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,color=colour1,legend=false,xlab=L"t",ylab=L"C_{z_{i},0.95}")
...
coverage_r_union_c2 = scatter!(t[2:end], sum(realisationst_withinbounds_time[:,2,2:end],dims=1)' ./totalseeds,xlim=(-0.1,5.1),ylim=(0,1.1),markersize=10,msw=0, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,color=colour2,legend=false,xlab=L"t",ylab=L"C_{z_{i},0.95}")
...
coverage_MLE_c1 = scatter!(t[2:end], sum(realisations_MLE_withinbounds_time[:,1,2:end],dims=1)' ./totalseeds,xlim=(-0.1,5.1), ylim=(0,1.1),markersize=10,msw=0, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,color=colour1,legend=false,xlab=L"t",ylab=L"C_{z_{i},0.95}")
...
coverage_MLE_c2 = scatter!(t[2:end], sum(realisations_MLE_withinbounds_time[:,2,2:end],dims=1)' ./totalseeds, xlim=(-0.1,5.1),ylim=(0,1.1),markersize=10,msw=0, titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,color=colour2,legend=false,xlab=L"t",ylab=L"C_{z_{i},0.95}")
