...
# Fig3_ODELinear_LogNormalNoise_NormalFit
...
isdir(pwd() * "\\Fig3_ODELinear_LogNormalNoise_NormalFit\\") || mkdir(pwd() * "\\Fig3_ODELinear_LogNormalNoise_NormalFit") # make folder to save figures if doesnt already exist
filepath_save = [pwd() * "\\Fig3_ODELinear_LogNormalNoise_NormalFit\\"] # location to save figures
filepath_load = [pwd() * "\\Fig5_ODELinear_LogNormalNoise_LogNormalFit\\"] # location to load data
