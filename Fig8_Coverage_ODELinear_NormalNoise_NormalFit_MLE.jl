...
# Fig8_Coverage_ODELinear_NormalNoise_NormalFit_MLE
...
isdir(pwd() * "\\Fig8_Coverage_ODELinear_NormalNoise_NormalFit_MLE\\") || mkdir(pwd() * "\\Fig8_Coverage_ODELinear_NormalNoise_NormalFit_MLE") # make folder to save figures if doesnt already exist
filepath_save = [pwd() * "\\Fig8_Coverage_ODELinear_NormalNoise_NormalFit_MLE\\"] # location to save figures "\\Fig2\\"] # location to save figures
