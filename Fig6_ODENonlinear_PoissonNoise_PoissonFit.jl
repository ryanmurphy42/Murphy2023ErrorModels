...
# Fig6_ODENonlinear_PoissonNoise_PoissonFit
...
isdir(pwd() * "\\Fig6_ODENonlinear_PoissonNoise_PoissonFit\\") || mkdir(pwd() * "\\Fig6_ODENonlinear_PoissonNoise_PoissonFit") # make folder to save figures if doesnt already exist
filepath_save = [pwd() * "\\Fig6_ODENonlinear_PoissonNoise_PoissonFit\\"] # location to save figures "\\Fig2\\"] # location to save figures
...
## Generate Synthetic data
    ...
    data_dists=[Poisson(mi) for mi in data0] # define Poisson distribution at each point
...
p0=scatter!(t,data[1,:],xlims=(0,t_max*1.1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour1) # scatter c1
p0=scatter!(t,data[2,:],xlims=(0,t_max*1.1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour2) # scatter c2
...
### Parameter identifiability analysis - MLE, profiles
    ...
    p1=scatter!(t,data[1,:],xlims=(0,t_max*1.1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour1) # scatter c1
    p1=scatter!(t,data[2,:],xlims=(0,t_max*1.1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour2) # scatter c2
    ...
    savefig(p1,filepath_save[1] * "Fig1" * ".pdf")
        ...
        profile2=plot(interp_points_P2range,interp_nllP2,xlim=(P2min,P2max),ylim=(-4,0.1),yticks=[-3,-2,-1,0],xlab=L"K_{1}",ylab=L"\hat{\ell}_{p}",legend=false,lw=5,titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=:deepskyblue3)
        ...
        profile3=plot(interp_points_P3range,interp_nllP3,xlim=(P3min,P3max),ylim=(-4,0.1),yticks=[-3,-2,-1,0],xlab=L"V_{2}",ylab=L"\hat{\ell}_{p}",legend=false,lw=5,titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=:deepskyblue3)
        ...
        p1_updated=scatter!(t,data[2,:],xlims=(0,t_max*1.1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour2,msw=0) # scatter c2
        ...
        # Confidence sets for model solutions
           ...
           confmodel1=scatter!(t,data[2,:],xlims=(0,t_max+1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour2,msw=0) # scatter c2
           ...
           confmodel2=scatter!(t,data[2,:],xlims=(0,t_max+1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour2,msw=0) # scatter c2
           ...
           confmodel3=scatter!(t,data[1,:],xlims=(0,t_max+1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour1,msw=0) # scatter c1
           confmodel3=scatter!(t,data[2,:],xlims=(0,t_max+1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour2,msw=0) # scatter c2
           ...
           confmodel4=scatter!(t,data[1,:],xlims=(0,t_max+1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour1,msw=0) # scatter c1
           confmodel4=scatter!(t,data[2,:],xlims=(0,t_max+1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour2,msw=0) # scatter c2
           ...
           confmodelu=scatter!(t,data[2,:],xlims=(0,t_max+1),ylims=(0,ymax),legend=false,markersize = 8,markercolor=colour2,msw=0) # scatter c2
...
#########################################################################################
        ...
        confmodeldiff1=plot!(t_smooth,0 .* ymle_smooth[2,:],w=0,c=colour2,ribbon=(ymle_smooth[2,:].-min_P1[2,:],max_P1[2,:].-ymle_smooth[2,:]),fillalpha=.2,xlab=L"t",ylab=L"C_{y,0.95}^{r_{1}} - y(\hat{\theta})",lw=0,titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour2)
        ...
        confmodeldiff2=plot!(t_smooth,0 .* ymle_smooth[2,:],w=0,c=colour2,ribbon=(ymle_smooth[2,:].-min_P2[2,:],max_P2[2,:].-ymle_smooth[2,:]),fillalpha=.2,xlab=L"t",ylab=L"C_{y,0.95}^{r_{2}} - y(\hat{\theta})",lw=0,titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour2)
        ...
        confmodeldiff3=plot!(t_smooth,0 .* ymle_smooth[2,:],w=0,c=colour2,ribbon=(ymle_smooth[2,:].-min_P3[2,:],max_P3[2,:].-ymle_smooth[2,:]),fillalpha=.2,xlab=L"t",ylab=L"C_{y,0.95}^{\sigma_{L}} - y(\hat{\theta})",lw=0,titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour2)
        ...
        confmodeldiff4=plot!(t_smooth,0 .* ymle_smooth[2,:],w=0,c=colour2,ribbon=(ymle_smooth[2,:].-min_P4[2,:],max_P4[2,:].-ymle_smooth[2,:]),fillalpha=.2,xlab=L"t",ylab=L"C_{y,0.95}^{\sigma_{L}} - y(\hat{\theta})",lw=0,titlefont=fnt, guidefont=fnt, tickfont=fnt, legendfont=fnt,linecolor=colour2)
