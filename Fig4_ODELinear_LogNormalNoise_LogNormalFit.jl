...
# Fig4_ODELinear_LogNormalNoise_LogNormalFit
...
isdir(pwd() * "\\Fig4_ODELinear_LogNormalNoise_LogNormalFit\\") || mkdir(pwd() * "\\Fig4_ODELinear_LogNormalNoise_LogNormalFit") # make folder to save figures if doesnt already exist
filepath_save = [pwd() * "\\Fig4_ODELinear_LogNormalNoise_LogNormalFit\\"] # location to save figures "\\Fig2\\"] # location to save figures
